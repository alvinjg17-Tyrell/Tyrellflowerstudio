      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl text-tyrell-dark font-light tracking-tight">
            ...
            <span className="text-tyrell-gold"> clientes</span>
          </h2>
        </div>
            ...
            >
              ...
              <div className="flex gap-1 mb-5">
                {[...Array(testimonial.rating)].map((_, i) => (
                  <Star
                    key={i}
                    className="w-4 h-4 text-tyrell-gold fill-tyrell-gold"
                  />
                ))}
              </div>
              ...
              <div className="mt-6 pt-6 border-t border-tyrell-gold/10">
                <span className="font-display text-base text-tyrell-dark font-medium tracking-wide">
                  {testimonial.name}
                </span>
              </div>
            </div>
