...
export const ServicesSection = () => {
  ...
  return (
    <section
      id="servicios"
      ref={sectionRef}
      className="relative py-24 lg:py-32 bg-tyrell-cream/40 overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl text-tyrell-dark font-light tracking-tight">
            Creaciones para cada
            <span className="text-tyrell-gold"> momento</span>
          </h2>
            ...
            >
              <div className={`relative overflow-hidden ${index === 0 ? "h-64 lg:h-80" : "h-56 lg:h-64"}`}>
                ...
                <div className="absolute top-4 left-4">
                  <Badge className="bg-white/90 text-tyrell-dark text-[10px] tracking-wider uppercase font-medium rounded-none px-3 py-1 hover:bg-white/90">
                    {service.tag}
                  </Badge>
                </div>
              ...
              <div className="p-6 lg:p-8">
                <h3 className="font-display text-xl lg:text-2xl text-tyrell-dark font-medium tracking-wide group-hover:text-tyrell-gold transition-colors duration-300">
                  {service.title}
                </h3>
                <p className="mt-3 text-tyrell-dark/50 text-sm font-light leading-relaxed">
                  {service.description}
                </p>
